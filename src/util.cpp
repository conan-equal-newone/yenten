...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "yenten.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "yentend.pid"));
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong Yenten will not work properly.");
