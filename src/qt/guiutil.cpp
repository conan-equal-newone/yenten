...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Yenten address (e.g. ZNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
#endif
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Yenten.lnk";
}
