...
##perform gitian builds
 ...
 Build bitcoind and bitcoin-qt on Linux32, Linux64, and Win32:
	...
	./bin/gbuild --commit yenten=z${VERSION} ../yenten/contrib/gitian-descriptors/gitian-linux.yml
	#./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../yenten/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r yenten-${VERSION}-linux-gitian.zip *
	mv yenten-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit yenten=z${VERSION} ../yenten/contrib/gitian-descriptors/gitian-win.yml
	#./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../yenten/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r yenten-${VERSION}-win-gitian.zip *
	mv yenten-${VERSION}-win-gitian.zip ../../../
	popd
	./bin/gbuild --commit yenten=z${VERSION} ../yenten/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
	#./bin/gsign --signer $SIGNER --release ${VERSION}-osx --destination ../gitian.sigs/ ../yenten/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
	pushd build/out
	mv Yenten-Qt.dmg ../../../
	popd
	popd
